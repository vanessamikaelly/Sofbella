    ...
    public class ComandaDAO
    {
        ...
        public int Insert(Comanda comanda)
        {
            try
            {
                ...
                query.CommandText = "INSERT INTO comanda (profissional_blo, data_inicio_blo, hora_inicio_blo, data_fim_blo, hora_fim_blo, motivo_bloqueio_blo, dia_inteiro_blo) " +
                                    "VALUES (@Profissional, @DataInicio, @HoraInicio, @DataFinal, @HoraFinal, @Motivo, @DiaInteiro)";

                query.Parameters.AddWithValue("@Profissional", comanda.Profissional);
                query.Parameters.AddWithValue("@DataInicio", comanda.DataInicio);
                query.Parameters.AddWithValue("@HoraInicio", comanda.HoraInicio);
                query.Parameters.AddWithValue("@DataFinal", comanda.DataFinal);
                query.Parameters.AddWithValue("@HoraFinal", comanda.HoraFinal);
                query.Parameters.AddWithValue("@Motivo", comanda.Motivo);
                query.Parameters.AddWithValue("@DiaInteiro", comanda.DiaInteiro);
