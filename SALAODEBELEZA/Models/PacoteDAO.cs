...
namespace SALAODEBELEZA.Models
{
    public class PacoteDAO
    {
        ...
        public int Insert(Pacote pacote)
        {
            try
            {
                ...
                query.CommandText = "INSERT INTO pacote (nome_pacote_pac, valor_pacote_pac, validade_pacote_pac, itens_pacote_pac) " +
                                    "VALUES (@Nome, @Valor, @Validade, @Itens)";

                query.Parameters.AddWithValue("@Nome", pacote.Nome);
                query.Parameters.AddWithValue("@Valor", pacote.Valor);
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    lista.Add(new Pacote
                    {
                        ...
                        Valor = reader.GetFloat("valor_pacote_pac"),
        ...
        public Pacote GetById(int id)
        {
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    pacote.Valor = reader.GetFloat("valor_pacote_pac");
        ...
        public void Update(Pacote pacote)
        {
            ...
            {
                var query = conn.Query();
                query.CommandText = "UPDATE pacote SET nome_pacote_pac = @Nome, valor_pacote_pac = @Valor, validade_pacote_pac = @Validade, itens_pacote_pac = @Itens " +
                                    "WHERE id_pac = @Id";
